...
import { listPrivateDiariesByAuthor, likePost } from "../logic/communityLogic";
...
export default function DiaryScreen({
  ...
  useEffect(() => {
    setPosts(listPrivateDiariesByAuthor(currentUserId));
  }, [currentUserId]);

  const refresh = () => setPosts(listPrivateDiariesByAuthor(currentUserId));
